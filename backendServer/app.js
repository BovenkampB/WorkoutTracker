...
const dbUsername = CONFIG.mongoDbUsername;
const dbPassword = CONFIG.mongoDbPassword;
const mongoDatabaseName = CONFIG.mongoDbName;
const mongoCollectionName = CONFIG.collectionName;

const uri = "mongodb+srv://" + dbUsername + ":" + dbPassword + "@cluster0.osle3ab.mongodb.net/?retryWrites=true&w=majority";
...
//TODO: below are examples of insert and find queries on a DB.
//
//     /*
//      * *** FIND DOCUMENTS ***
//      *
